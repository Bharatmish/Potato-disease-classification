...
MODEL = tf.keras.models.load_model("../api/saved_models/1")
CLASS_NAMES = ["Early Blight", "Late Blight", "Healthy"]

# OpenAI API Configuration
API_KEY = os.getenv("API_KEY")  # Retrieve API key from .env file
ENDPOINT = os.getenv("API_ENDPOINT")  # Retrieve API endpoint from .env file

if not API_KEY or not ENDPOINT:
    raise ValueError("API_KEY or API_ENDPOINT is not set in the .env file.")
